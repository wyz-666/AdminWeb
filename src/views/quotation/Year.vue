<template>
  <el-row :gutter="12">
    ...
    <el-button type="success" @click="exportExcel" style="margin-left: 10px;">导出CEA当月年度报价及均值</el-button>
    <el-col :span="24">
...
export default {
  ...
  methods: {
    getAVG() {
      ...
      this.$axios.get('/admin/getYearQuotation', {
        params: {
          time: dateString,
          product: 'CEA'
        }
      ...
      this.$axios.get('/admin/getNewYearAvg', {
        params: {
          nowTime: dateString,
          product: 'CEA'
        }
