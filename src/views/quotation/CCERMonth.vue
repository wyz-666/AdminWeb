<template>
  <el-row :gutter="12">
    ...
    />
    <el-button type="primary" @click="getAVG">获得当月CCER报价情况</el-button>
    <el-button type="success" @click="exportExcel" style="margin-left: 10px"
      >导出CCER当月报价及均值</el-button
    >
    <el-col :span="24">
        ...
        <el-table :data="tableData1" border style="width: 100%">
          ...
          <el-table-column prop="type" label="账户类型" width="100">
            <template #default="scope">
              ...
              <el-tag size="mini" type="danger" v-if="scope.row.type === 2"
                >会员账号</el-tag
              >
            </template>
          </el-table-column>
      ...
      <el-dialog title="提交角色比例" v-model="dialogFormVisible" width="30%">
        ...
        <template #footer>
          <span class="dialog-footer">
            ...
            <el-button size="mini" type="primary" @click="uploadRatio"
              >查看结果</el-button
            >
          </span>
        </template>
...
export default {
  ...
  methods: {
    ...
    exportExcel() {
      ...
      XLSX.utils.book_append_sheet(workbook, worksheet, "CCER当月报价");
      XLSX.utils.book_append_sheet(workbook, worksheet1, "CCER当月报价均值");
      // 3. 写出文件数据
      const excelBuffer = XLSX.write(workbook, { bookType: "xlsx", type: "array" });
      // 4. 保存文件
      const blob = new Blob([excelBuffer], { type: "application/octet-stream" });
      saveAs(blob, `CCER当月报价及均值-${dayjs(this.date).format("YYYY-MM-DD")}.xlsx`);
    },
  },
};
</script>
